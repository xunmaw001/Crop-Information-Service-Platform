  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">农作物信息服务平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.gerenshenfen" class="input" type="text" placeholder="个人身份">
			   </div>
			 </div> -->
			<el-form-item label="个人身份" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.gerenshenfen" autocomplete="off" placeholder="个人身份"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">

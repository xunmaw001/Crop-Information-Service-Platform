<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资料来源" prop="ziliaolaiyuan">
          <el-input v-model="ruleForm.ziliaolaiyuan" 
              placeholder="资料来源" clearable  :readonly="ro.ziliaolaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资料来源" prop="ziliaolaiyuan">
              <el-input v-model="ruleForm.ziliaolaiyuan" 
                placeholder="资料来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirong = true;
          ...
          if(o=='ziliaolaiyuan'){
            this.ruleForm.ziliaolaiyuan = obj[o];
	    this.ro.ziliaolaiyuan = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssm6327e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `nongyezixun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.nongyezixunCrossAddOrUpdateFlag = false;
                  this.parent.search();

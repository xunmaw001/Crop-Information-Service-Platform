<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人身份" prop="gerenshenfen">
          <el-input v-model="ruleForm.gerenshenfen" 
              placeholder="个人身份" clearable  :readonly="ro.gerenshenfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人身份" prop="gerenshenfen">
              <el-input v-model="ruleForm.gerenshenfen" 
                placeholder="个人身份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='gerenshenfen'){
            this.ruleForm.gerenshenfen = obj[o];
	    this.ro.gerenshenfen = true;
            continue;
          }
          if(o=='shouji'){
